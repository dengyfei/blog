  ...
  '@vuepress-reco/vuepress-plugin-bgm-player': {
    ...
    audios: [
      ...
      },
      {
        name: '不再犹豫',
        artist: 'Beyond',
        url: 'https://music.163.com/song/media/outer/url?id=346084.mp3',
        cover:
      ...
      },
      {
        name: '相思风雨中',
        artist: '张学友 / 汤宝如',
        url: 'https://music.163.com/song/media/outer/url?id=188555.mp3',
        cover:
      ...
      },
      {
        name: '月半小夜曲',
        artist: '李克勤',
        url: 'https://music.163.com/song/media/outer/url?id=115162.mp3',
        cover:
      ...
      },
      {
        name: '丑八怪',
        artist: '薛之谦',
        url: 'https://music.163.com/song/media/outer/url?id=27808044.mp3',
        cover:
